...
func (s *AgentsService) SimulateConversation(ctx context.Context, agentID string, opts *SimulateConversationOptions) ([]*SimulationMessage, error) {
	if agentID == "" {
...
func (s *AgentsService) SimulateConversationStream(ctx context.Context, agentID string, opts *SimulateConversationOptions) (*SimulationConnection, error) {
	if agentID == "" {
		return nil, &APIError{Message: "agent_id is required"}
	}
...
func (s *AgentsService) buildSimulationWebSocketURL(agentID string) (string, error) {
